...
os.system('svn export .. Fish')

os.remove('Fish/doc/Post.html')
os.remove('Fish/doc/UpdateBlog.py')
...
if False:
    SendFile(ftp, "Fish/demo/Fish.c")
    SendFile(ftp, "Fish/demo/Fish.glsl")
    SendFile(ftp, "Fish.zip")
    SendFile(ftp, "*.png")
