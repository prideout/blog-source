...
os.system('svn export .. Tron')

os.remove('Tron/doc/Post.html')
os.remove('Tron/doc/UpdateBlog.py')
...
if False:
    SendFile(ftp, "Tron.zip")
    SendFile(ftp, "Tron/Curve.cpp")
    SendFile(ftp, "Tron/Glow.glsl")
    SendFile(ftp, "Tron/Cylinder.glsl")
    SendFile(ftp, "*.png")
