...
try:
    shutil.rmtree('TriangleTess')
except:
    pass

print "Exporting SVN repo..."
os.system('svn export .. TriangleTess')

if True:
    try:
        shutil.rmtree('TriangleTess/deploy')
    except:
        pass
    try:
        shutil.rmtree('TriangleTess/chart')
    except:
        pass
...
def zipper(dir, zip_file):
    ...
    for root, dirs, files in os.walk(dir):
        ...
        for f in files:
            if not f.endswith('.gif') and not f.endswith('.png'):
...
zipper("TriangleTess", 'TriangleTess.zip')
tarballer("TriangleTess", 'TriangleTess.tar.gz')
...
if True:
    ...
    SendFile(ftp, "TriangleTess.zip")
    SendFile(ftp, "TriangleTess.tar.gz")
    SendFile(ftp, "TriangleTess/chart/*.png")
    SendFile(ftp, "TriangleTess/Geodesic.gif")
    SendFile(ftp, "TriangleTess/Geodesic.*")
