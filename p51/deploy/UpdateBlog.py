...
os.system('svn export .. Glass')

if True:
    try:
        shutil.rmtree('Glass/deploy')
        shutil.rmtree('Glass/ios')
    except:
        pass
...
SendFile(ftp, "Glass/Glass.c")
SendFile(ftp, "Glass/Glass.glsl")
SendFile(ftp, "Glass.zip")
SendFile(ftp, "*.png")
