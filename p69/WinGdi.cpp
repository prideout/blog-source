...
void ExportScreenshot(const char* filename)
{
    ...
    HDC memdc = CreateCompatibleDC(DcBackbuffer);
    HBITMAP membit = CreateCompatibleBitmap(DcBackbuffer, Width, Height);
    HBITMAP hOldBitmap = (HBITMAP) SelectObject(memdc, membit);
    BitBlt(memdc, 0, 0, Width, Height, DcBackbuffer, 0, 0, SRCCOPY);
