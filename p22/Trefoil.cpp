...
namespace VertexAttributes
{
    ...
    static const GLvoid* NormalOffset = (GLvoid*) sizeof(vec3);
};
...
static vec3 EvaluateTrefoil(float s, float t);
...
void Render()
{
    ...
    glVertexAttribPointer(VertexAttributes::Position, 3, GL_FLOAT, GL_FALSE, sizeof(Vertex), 0);
