...
os.system('svn export .. Splat')

os.remove('Splat/doc/Post.html')
os.remove('Splat/doc/UpdateBlog.py')
...
if False:
    SendFile(ftp, "Splat.zip")
    SendFile(ftp, "Splat/Volume.glsl")
    SendFile(ftp, "Splat/Streamline.glsl")
    SendFile(ftp, "Splat/Splat.glsl")
    SendFile(ftp, "*.png")
