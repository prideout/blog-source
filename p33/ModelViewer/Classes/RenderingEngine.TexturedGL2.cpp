...
namespace TexturedGL2 {
    
#define STRINGIFY(A)  #A
#include "../Shaders/TexturedLighting.gl2.vert"
#include "../Shaders/TexturedLighting.gl2.frag"
...
void RenderingEngine::Render(const vector<Visual>& visuals) const
{
    ...
    for (int visualIndex = 0; visual != visuals.end(); ++visual, ++visualIndex) {
        ...
        glVertexAttrib4f(m_attributes.Diffuse, color.x, color.x, color.x, 1);
