...
try:
    shutil.rmtree('Silhouette')
except:
    pass

print "Exporting SVN repo..."
os.system('svn export .. Silhouette')

if True:
    try:
        shutil.rmtree('Silhouette/deploy')
    except:
        pass
...
zipper("Silhouette", 'Silhouette.zip')
...
if False:
    SendFile(ftp, "Silhouette/Silhouette.c")
    SendFile(ftp, "Silhouette/Silhouette.glsl")
    SendFile(ftp, "Silhouette/Adjacency.c")
    SendFile(ftp, "Silhouette.zip")
SendFile(ftp, "*.png")
