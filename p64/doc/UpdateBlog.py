...
ftp.retrlines('LIST')
shutil.rmtree('raycast', True)

print "Exporting SVN repo..."
os.system('svn export .. raycast')
shutil.rmtree('raycast/doc', True)
...
if True:
    SendFile(ftp, "*.png")
    SendFile(ftp, "raycast.zip")
    SendFile(ftp, "raycast/SinglePass.glsl")
    SendFile(ftp, "raycast/Raycast.cpp")
