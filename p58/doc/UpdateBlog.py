...
os.system('svn export .. Fluid')

os.remove('Fluid/doc/Post.html')
os.remove('Fluid/doc/UpdateBlog.py')
os.remove('Fluid/doc/gradient.png')
os.remove('Fluid/doc/trim.dot')
os.remove('Fluid/doc/fluid.dot')
...
if True:
    SendFile(ftp, "Fluid.zip")
    SendFile(ftp, "Fluid/Fluid.h")
    SendFile(ftp, "Fluid/Fluid.c")
    SendFile(ftp, "Fluid/Fluid.glsl")
    SendFile(ftp, "Fluid/SlabOps.c")
